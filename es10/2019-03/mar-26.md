...
IS: I propose the following structure: TC39 plenary, TC39-TG1 (for General EcmaScript Language), TC39-TG2 (for Intl/Ecma402).  (reads the rest from slide 11-15)
...
DE: We have generally similar membership practices to TC39. Some attendees were invited guests, just as on TC39. Notes are published to Ecma402 repo. We’re open to publish in alternative locations, if there’s interest in that.
...
Presenter: Jory Burson (JBR)

*** TODO: NEED SLIDES ***

JBR: (presents [slides](https://docs.google.com/presentation/d/1FAGAtZFXUO8CPNnYKKwLXIynjqO_6v7SMQh1KxDnHPY/))
...
DE: This is a side issue that does not block the current proposal.

DE: We decided this was best to leave these kinds of decisions up to the library user. I think it’s really best if we can find multiple solutions here.
