...
API: Someone brought up this issue in the tracker. Unfortunately, there is no way in ECMA262 to distribute data about dates. 
...
ARE: To respond to something WH said, the rigidity against any sort of collaboration outside the realm of the meetings is problematic. Nothing is going to get done if there are no external groups…
