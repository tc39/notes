...
KG: And then a minor administrative thing. The IPR check is now enabled in github actions. Thank you to Jordan for making that all work and debugging GH actions, which is always a good time. As a reminder, please send the IPR form if you haven't. I know we have a few specific names of delegates who contributed previously hard-coded.
