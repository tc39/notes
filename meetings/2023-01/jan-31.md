...
PFC: Sorry, yes. That’s correct. And it’s not a change from the status quo. I guess the slide should say, "Objects _implementing the protocol_ are only accepted if they _fully_ implement the protocol."
